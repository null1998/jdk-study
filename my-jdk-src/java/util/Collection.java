 ...
 * Bags和multisets（无序并且可能含有重复元素，应该直接实现此接口）
 *
 ...
 * is empty.
 * 此接口中包含的破坏性方法，即如果此集合不支持此操作，
 * 该方法会抛出UnsupportedOperationException。
 * 如果该操作的调用对集合没有影响，这些方法可以抛出但不要求
 * 抛出UnsupportedOperationException。
 * 例如，调用不可修改集合上的addAll(Collection)方法，如果集合是空的，
 * 这些方法可以抛出但不要求抛出UnsupportedOperationException。
 *
 ...
 * interface.
 * 一些集合实现受到它们可能包含的元素的限制
 * 例如，某些实现禁止使用null元素，某些元素对其元素类型有限制。试图
